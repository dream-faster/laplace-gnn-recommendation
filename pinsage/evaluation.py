...
class LatestNNRecommender(object):
    ...
    def recommend(self, full_graph, K, h_user, h_item):
        ...
        assert t.equal(user, t.arange(n_users))

        recommended_batches = []
        user_batches = t.arange(n_users).split(self.batch_size)
        ...
        recommendations = t.cat(recommended_batches, 0)
...
if __name__ == "__main__":
    ...
    with open(args.item_embedding_path, "rb") as f:
        emb = t.FloatTensor(pickle.load(f))
