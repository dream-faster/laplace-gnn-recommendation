...
from . import AcademicDataset, HGBDataset, OHGBDataset, FashionDataset
...
@register_dataset("fashion_link_prediction")
class Fashion_LinkPrediction(LinkPredictionDataset):
    def __init__(self, dataset_name, *args, **kwargs):
        super(Fashion_LinkPrediction, self).__init__(*args, **kwargs)
        self.dataset_name = dataset_name
        self.has_feature = True
